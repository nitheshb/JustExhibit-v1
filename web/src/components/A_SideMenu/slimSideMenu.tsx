...
const SlimSideMenuBar = (props) => {
  ...
  return (
    <section className="h-screen">
      <div
        className={`flex flex-col items-center p-1 h-[624px] overflow-auto no-scrollbar shadow-[0_0_59px_0_rgba(0,0,0,0.06)] bg-white border border-[#EDEDED] rounded-[8px] m-4 transition-all duration-300 ease-in-out ${
          isCollapsed
            ? 'min-w-[60px] w-[60px] max-w-[60px]'
            : 'min-w-[90px] w-[90px] max-w-[90px]'
        }`}
      >
        {/* Collapse Toggle Button */}
        <button
          onClick={toggleCollapse}
          className="flex items-center justify-center w-8 h-8 mt-2 mb-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded transition-colors duration-200"
        ...
        {['crmModule'].includes(sourceLink) && (
          <>
            <ul className="w-full">
              ...
              {/* More Button - Only show when more items are hidden */}
              {!showMoreItems && (
                <li className="relative mt-1 pt-1">
                  <span
                    className="flex items-center text-sm px-2 py-4 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-[#F44D21] transition duration-300 ease-in-out cursor-pointer"
                  ...
                  >
                    ...
                    >
                      ...
                      {!isCollapsed && (
                        <span className="text-[12px] font-manrope tracking-[0.7px] text-center pl-1 pt-1 text-black">
                          More
                        </span>
                      )}
                    </span>
                      ...
                      <span>
                        ...
                        >
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M3.08767 2C2.96167 2 2.84933 2.08733 2.806 2.21867L2.03667 4.55567C2.01238 4.62957 2.5 4.70687 2.5 4.78467V5.71433C2.5 6.24 2.88367 6.66667 3.357 6.66667C3.83033 6.66667 4.21433 6.24 4.21433 5.71433C4.21433 6.24033 4.598 6.66667 5.07133 6.66667C5.54467 6.66667 5.92867 6.24 5.92867 5.71433C5.92867 6.24033 6.31233 6.66667 6.78567 6.66667C7.259 6.66667 7.64233 6.24067 7.643 5.715C7.643 6.24067 8.02667 6.66667 8.5 6.66667C8.97333 6.66667 9.357 6.24 9.357 5.71433C9.357 6.24033 9.741 6.66667 10.2143 6.66667C10.6877 6.66667 11.071 6.24067 11.0713 5.715C11.0717 6.24067 11.4553 6.66667 11.9287 6.66667C12.402 6.66667 12.7857 6.24 12.7857 5.71433C12.7857 6.24033 13.1693 6.66667 13.643 6.66667C14.1163 6.66667 14.5 6.24 14.5 5.71433V4.78467C14.5 4.70687 14.4876 4.62957 14.4633 4.55567L13.694 2.219C13.6507 2.08733 13.5383 2 13.4123 2H3.08767Z"
                            fill={
                              viewable === 'ongoing_projects'
                                ? 'white'
                                : 'black'
                          ...
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M3.33333 7.07659V9.66658H2.5C2.4558 9.66658 2.4134 9.68414 2.38215 9.7154C2.35089 9.74666 2.33333 9.78905 2.33333 9.83325V10.1666C2.33333 10.2108 2.35089 10.2532 2.38215 10.2844C2.4134 10.3157 2.4558 10.3333 2.5 10.3333H13.5C13.5442 10.3333 13.5866 10.3157 13.6178 10.2844C13.6491 10.2532 13.6667 10.2108 13.6667 10.1666V9.83325C13.6667 9.78905 13.6491 9.74666 13.6178 9.7154C13.5866 9.68414 13.5442 9.66658 13.5 9.66658H12.6667V7.07659C12.5271 7.02107 12.3982 6.94179 12.2857 6.84225C12.1991 6.91833 12.1031 6.98286 12 7.03425V9.66658H4.50001V7.03425C4.39689 6.98311 4.30087 6.91857 4.21434 6.8425C4.10234 6.94083 3.97434 7.02083 3.83334 7.07683ZM12 6.42425C12.0282 6.39603 12.0549 6.3657 12.08 6.33325H12V6.42425ZM12.4913 6.33325C12.5419 6.39841 12.6008 6.45658 12.6667 6.50625V6.33325H12.4913ZM3.33333 6.50625C3.39971 6.45723 3.45876 6.39897 3.50867 6.33325H3.33333V6.50625ZM3.92 6.33325H4V6.42425C3.97152 6.39556 3.9448 6.36517 3.92 6.33325ZM2.83333 10.9999C2.78913 10.9999 2.74674 11.0175 2.71548 11.0487C2.68422 11.08 2.66667 11.1224 2.66667 11.1666V13.6666C2.66667 13.755 2.70178 13.8398 2.7643 13.9023C2.82681 13.9648 2.91159 13.9999 3 13.9999H13C13.0884 13.9999 13.1732 13.9648 13.2357 13.9023C13.2982 13.8398 13.3333 13.755 13.3333 13.6666V11.1666C13.3333 11.1224 13.3158 11.08 13.2845 11.0487C13.2533 11.0175 13.2109 10.9999 13.1667 10.9999H2.83333Z"
                            fill={
                              viewable === 'ongoing_projects'
                                ? 'white'
                                : 'black'
                          ...
                          />
                          <path
                            d="M4.66667 8.83341C4.66667 8.78921 4.68423 8.74682 4.71548 8.71556C4.74674 8.68431 4.78913 8.66675 4.83333 8.66675H5.83333C5.87754 8.66675 5.91993 8.68431 5.95119 8.71556C5.98244 8.74682 6 8.78921 6 8.83341V9.50008C6 9.54428 5.98244 9.58668 5.95119 9.61793C5.91993 9.64919 5.87754 9.66675 5.83333 9.66675H4.83333C4.78913 9.66675 4.74674 9.64919 4.71548 9.61793C4.68423 9.58668 4.66667 9.54428 4.66667 9.50008V8.83341Z"
                            fill={
                              viewable === 'ongoing_projects'
                                ? 'white'
                                : 'black'
                          ...
                          <g clipPath="url(#clip0_441_3688)">
                            ...
                            />
                            <path
                              d="M15.0156 11.9218C14.7344 13.3281 13.6741 14.6522 12.1862 14.9481C11.4606 15.0926 10.7079 15.0045 10.0352 14.6963C9.36261 14.3881 8.80434 13.8756 8.43994 13.2317C8.07554 12.5878 7.92358 11.8453 8.0057 11.11C8.08782 10.3747 8.39983 9.684 8.89731 9.13634C9.91768 8.01246 11.6406 7.70309 13.0469 8.26559"
                              stroke="#4D4D4D"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                            />
                            <path
                              d="M10.2344 11.3594L11.6406 12.7656L15.0156 9.10938"
                              stroke="#4D4D4D"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                            />
                ...
                >
                  <span className="flex items-center flex-col">
                    <span>
                      ...
                      >
                        <path
                          d="M14.5 2H2.5C1.94772 2 1.5 2.44772 1.5 3V14C1.5 14.5523 1.94772 15 2.5 15H14.5C15.0523 15 15.5 14.5523 15.5 14V3C15.5 2.44772 15.0523 2 14.5 2Z"
                          fill={viewable === 'Today1' ? 'white' : 'black'}
                          stroke={viewable === 'Today1' ? 'white' : 'black'}
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                ...
                >
                  <span className="flex items-center flex-col">
                    <span>
                      ...
                      >
                        <path
                          d="M8.5 15C11.8137 15 14.5 12.3137 14.5 9C14.5 5.68629 11.8137 3 8.5 3C5.18629 3 2.5 5.68629 2.5 9C2.5 12.3137 5.18629 15 8.5 15Z"
                          fill={
                            viewable === 'MarketingSocial' ? 'white' : 'black'
                          }
                          stroke={
                            viewable === 'MarketingSocial' ? 'white' : 'black'
                          }
                        ...
                        />
                        <path
                          d="M12.5 5C13.0523 5 13.5 4.55228 13.5 4C13.5 3.44772 13.0523 3 12.5 3C11.9477 3 11.5 3.44772 11.5 4C11.5 4.55228 11.9477 5 12.5 5Z"
                          fill={
                            viewable === 'MarketingSocial' ? 'white' : 'black'
                          }
                          stroke={
                  ...
                  >
                    <span className="flex items-center flex-col">
                      <span>
                        ...
                        >
                          <path
                            d="M15.5 2H13.5V0H11.5V2H5.5V0H3.5V2H1.5C0.95 2 0.5 2.45 0.5 3V15C0.5 15.55 0.95 16 1.5 16H15.5C16.05 16 16.5 15.55 16.5 15V3C16.5 2.45 16.05 2 15.5 2ZM14.5 14H2.5V7H14.5V14ZM14.5 5H2.5V4H14.5V5Z"
                            fill={
                              viewable === 'Team Lead Report'
                                ? 'white'
                                : 'black'
                    ...
                    <span>
                      ...
                      >
                        <path
                          ...
                          fill={viewable === 'inProgress' ? 'white' : 'black'}
                          stroke={viewable === 'inProgress' ? 'white' : 'black'}
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M8.5 4.5V8.5L11.5 10.5"
                          fill={viewable === 'inProgress' ? 'white' : 'black'}
                          stroke={viewable === 'inProgress' ? 'white' : 'black'}
                          strokeWidth="2"
                          strokeLinecap="round"
                ...
                >
                  <span className="flex items-center flex-col">
                    <span>
                      ...
                      >
                        <path
                          d="M13.5 3H3.5C2.94772 3 2.5 3.44772 2.5 4V13C2.5 13.5523 2.94772 14 3.5 14H13.5C14.0523 14 14.5 13.5523 14.5 13V4C14.5 3.44772 14.0523 3 13.5 3Z"
                          fill={
                            viewable === 'archieveLeads' ? 'white' : 'black'
                          }
                          stroke={
                            viewable === 'archieveLeads' ? 'white' : 'black'
                          }
              ...
              <li className="relative justify-center ">
                ...
                >
                  <span className="flex items-center flex-col pt-[8px]">
                    ...
                    {!isCollapsed && (
                      <span className="text-[9px] font-bold tracking-[0.7px]">
                        Tasks
                      </span>
                    )}
                  </span>
                ...
                >
                  <span className="flex items-center flex-col">
                    <span>
                      ...
                      >
                        <path
                          d="M15.5 4H1.5C0.947715 4 0.5 4.44772 0.5 5V13C0.5 13.5523 0.947715 14 1.5 14H15.5C16.0523 14 16.5 13.5523 16.5 13V5C16.5 4.44772 16.0523 4 15.5 4Z"
                          fill={viewable === 'Payments' ? 'white' : 'black'}
                          stroke={viewable === 'Payments' ? 'white' : 'black'}
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                ...
                >
                  <span className="flex items-center flex-col">
                    <span>
                      ...
                      >
                        <path
                          d="M14.5 2H2.5C1.94772 2 1.5 2.44772 1.5 3V13C1.5 13.5523 1.94772 14 2.5 14H14.5C15.0523 14 15.5 13.5523 15.5 13V3C15.5 2.44772 15.0523 2 14.5 2Z"
                          fill={
                            viewable === 'Bank Accounts' ? 'white' : 'black'
                          }
                          stroke={
                            viewable === 'Bank Accounts' ? 'white' : 'black'
                          }
                  ...
                  <span className="flex items-center flex-col">
                    <span>
                      ...
                      >
                        <path
                          d="M8.5 15C11.8137 15 14.5 12.3137 14.5 9C14.5 5.68629 11.8137 3 8.5 3C5.18629 3 2.5 5.68629 2.5 9C2.5 12.3137 5.18629 15 8.5 15Z"
                          fill={viewable === 'Dashboard' ? 'white' : 'black'}
                          stroke={viewable === 'Dashboard' ? 'white' : 'black'}
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                    ...
                    <span>
                      ...
                      >
                        <path
                          d="M4.49999 8.58309C5.07125 8.58309 5.50436 8.57686 5.87792 8.67684C6.82671 8.93107 7.56781 9.67248 7.82226 10.6212C7.89735 10.9014 7.91312 11.2154 7.91601 11.5958V12.4034C7.91313 12.7839 7.89732 13.0977 7.82226 13.378C7.56797 14.327 6.82692 15.0681 5.87792 15.3223C5.59759 15.3974 5.28382 15.4132 4.90331 15.4161H4.09569C3.71535 15.4132 3.40132 15.3974 3.12108 15.3223C2.17238 15.0679 1.43098 14.3268 1.17675 13.378C1.07677 13.0045 1.083 12.5713 1.083 12.0001C1.083 11.4285 1.07662 10.9949 1.17675 10.6212C1.4311 9.67249 2.1724 8.93119 3.12108 8.67684C3.49476 8.57671 3.92846 8.58309 4.49999 8.58309ZM12.5 8.58309C13.0713 8.58309 13.5044 8.57686 13.8779 8.67684C14.8267 8.93107 15.5678 9.67247 15.8223 10.6212C15.8973 10.9014 15.9131 11.2154 15.916 11.5958V12.4034C15.9131 12.7839 15.8973 13.0977 15.8223 13.378C15.568 14.327 14.8269 15.0681 13.8779 15.3223C13.5976 15.3974 13.2838 15.4132 12.9033 15.4161H12.0957C11.7154 15.4132 11.4013 15.3974 11.1211 15.3223C10.1724 15.0679 9.43098 14.3268 9.17675 13.378C9.07677 13.0045 9.083 12.5713 9.083 12.0001C9.083 11.4285 9.07662 10.9949 9.17675 10.6212C9.4311 9.67249 10.1724 8.93119 11.1211 8.67684C11.4948 8.57671 11.9285 8.58309 12.5 8.58309ZM4.49999 0.58309C5.07125 0.583087 5.50436 0.576861 5.87792 0.67684C6.82671 0.931068 7.56781 1.67248 7.82226 2.62118C7.89735 2.90141 7.91312 3.21544 7.91601 3.59579V4.4034C7.91313 4.78391 7.89732 5.09768 7.82226 5.37801C7.56797 6.32702 6.82692 7.06806 5.87792 7.32235C5.59759 7.39742 5.28382 7.41322 4.90331 7.4161H4.09569C3.71535 7.41321 3.40132 7.39744 3.12108 7.32235C2.17238 7.0679 1.43098 6.3268 1.17675 5.37801C1.07677 5.00445 1.083 4.57135 1.083 4.00008C1.083 3.42855 1.07662 2.99485 1.17675 2.62118C1.4311 1.67249 2.1724 0.931188 3.12108 0.67684C3.49476 0.576713 3.92846 0.583087 4.49999 0.58309ZM12.5 0.58309C13.0713 0.583087 13.5044 0.576861 13.8779 0.67684C14.8267 0.931068 15.5678 1.67248 15.8223 2.62118C15.8973 2.90141 15.9131 3.21544 15.916 3.59579V4.4034C15.9131 4.78391 15.8973 5.09768 15.8223 5.37801C15.568 6.32702 14.8269 7.06806 13.8779 7.32235C13.5976 7.39742 13.2838 7.41322 12.9033 7.4161H12.0957C11.7154 7.41321 11.4013 7.39744 11.1211 7.32235C10.1724 7.0679 9.43098 6.3268 9.17675 5.37801C9.07677 5.00445 9.083 4.57135 9.083 4.00008C9.083 3.42855 9.07662 2.99485 9.17675 2.62118C9.4311 1.67249 10.1724 0.931188 11.1211 0.67684C11.4948 0.576713 11.9285 0.583087 12.5 0.58309Z"
                          fill={
                            viewable === 'User Management' ? 'white' : 'black'
                          }
                        />
                      </svg>
                    </span>
