...
const SlimSideMenuBar = (props) => {
  ...
  return (
    <section className="h-screen">
      ...
      <div className="flex flex-col items-center p-1 min-w-[90px] h-[524px] w-[90px] max-w-[90px]   overflow-auto no-scrollbar shadow-[0_0_59px_0_rgba(0,0,0,0.06)]  bg-white  border border-[#EDEDED] rounded-[8px] m-4">
        {[
          'hrModule',
          'financeModule',
          'crmModule',
