...
const TemplatesHomeList = ({ title, dialogOpen, data }) => {
            ...
            <div className=" flex">
              <div className="flex flex-col">
                ...
                >
                  ...
                  <span className="pt-[5px]">Welcome Template</span>
                </button>
                ...
                <button className="templateItem" tabIndex="0" type="button">
                  ...
                  <span className="pt-[5px]">Marketing Script</span>
                </button>
              </div>
            </div>
          </div>
...
export default TemplatesHomeList
