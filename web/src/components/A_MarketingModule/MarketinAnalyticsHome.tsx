...
const MarketingAnalyticsHome = () => {
  const [isClicked, setisClicked] = useState('business_tasks')
  return (
    <div className="flex flex-col  mt-2 drop-shadow-md rounded-lg  px-2">
      <div className="flex flex-col  mt-2 drop-shadow-md rounded-lg ">
        <div className="m-2">
          <div className="flex flex-col gap-4">
            <div className="flex flex-row flex-wrap gap-2">
              <div className="bg-[#fff] rounded-lg shadow-xl w-[75%] ">
                {/* Block 1 */}
...
export default MarketingAnalyticsHome
