...
const valueFeedData = [
  { k: 'Casual Leaves', v: 4, pic: '' },
  { k: 'Earned Leaves', v: 59, pic: '' },
  { k: 'Flexible Holidays', v: 6, pic: '' },
  { k: 'Sick Leaves', v: 12, pic: '' },
]

const MyAttedanceHomeBody = ({ project, onSliderOpen = () => {}, isEdit }) => {
  const {
    area,
    builderName,
    location,
...
export default MyAttedanceHomeBody
