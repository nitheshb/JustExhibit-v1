...
const ViewUnitDetails = ({
  ...
  return (
    <div className="h-full flex flex-col bg-white shadow-xl  ">
      <div className="px-[30px] py-[20px]  z-10 flex items-center justify-between shadow-[0px_4px_30px_0px_rgba(0,0,0,0.05)] ">
          ...
          <div className="flex flex-row  justify-between mb-1">
            <section className="flex flex-row  items-center gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <span className="border border-[#E5E5E5] font-medium px-3 py-1.5 rounded-full flex items-center text-[10px] leading-[100%] tracking-[0] text-[#43B75D] font-manrope max-w-[90px] truncate">
