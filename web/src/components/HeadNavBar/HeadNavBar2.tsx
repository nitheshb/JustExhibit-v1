...
const HeadNavBar2 = ({ selModule, setSelModule, setViewable }) => {
  ...
  return (
    <div className="">
      <div className="flex items-center flex-shrink-0 h-[76px] px-[20px] pl-0 bg-white shadow-[0_0_23.2px_0_rgba(0,0,0,0.12)]">
        <div className="flex gap-[24px]">
          ...
          >
            ...
            <span className="font-manrope font-bold text-[20px] leading-[100%] tracking-[0] text-black">
              EventKit
            </span>
          </span>
        ...
        <div className="flex gap-6">
          ...
          >
            ...
            <Box display="flex" flexDirection="column" mr={2}>
              <Typography
                variant="body2"
                className="font-semibold text-[13px] leading-[100%] tracking-[0%] text-[#0A0A0A] font-manrope"
              >
                {user?.displayName}
              </Typography>
              <Typography
                variant="caption"
                className="font-normal text-[12px] leading-[100%] tracking-[0%] text-[#949494] font-manrope"
              >
                {user?.roles?.length > 0
                  ? user?.roles[0] == 'admin'
                    ? 'Super User'
