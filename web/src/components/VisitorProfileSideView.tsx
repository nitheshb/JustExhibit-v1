...
export default function VisitorProfileSideView({
  openUserProfile,
  customerDetails,
  unitViewerrr,
  unitsViewMode,
  ...
  const [selFeature, setFeature] = useState('qrCode')
  ...
  return (
    ...
    >
      ...
      <div className="h-screen overflow-y-auto">
        ...
        {!unitsViewMode && (
          <>
            <section className=" pb-8 pt-1 px-2 mt-[0.5px] rounded-xs bg-[#FFFFFF]">
              <div className="">
                <div className="">
