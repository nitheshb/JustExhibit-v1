...
//       className={`mr-4 px-4 py-1 focus:outline-none focus:ring-2 focus:ring-indigo-800
...
//           <div className="shadow overflow-hidden border-b border-gray-200  bg-white pb-4  px-2 ">
  ...
  useEffect(() => {
    if (leadsFetchedData.length > 0) {
      const counts = {
        ...
        admin: leadsFetchedData.filter(userD => userD.department === 'admin').length,
        crm: leadsFetchedData.filter(userD => userD.department === 'crm').length,
        marketing: leadsFetchedData.filter(userD => userD.department === 'marketing').length,
        project: leadsFetchedData.filter(userD => userD.department === 'project').length,
        sales: leadsFetchedData.filter(userD => userD.department === 'sales').length,
        hr: leadsFetchedData.filter(userD => userD.department === 'hr').length,
        finance: leadsFetchedData.filter(userD => userD.department === 'finance').length,
        admin_support: leadsFetchedData.filter(userD => userD.department === 'admin_support').length,
      }
