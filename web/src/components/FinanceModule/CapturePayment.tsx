  ...
  "
                                                        ...
                                                        <span className=" leading-[15px] ">
                                                          <div className="flex items-center gap-2 mb-2">
                                                            ...
                                                            >
                                                              ...
                                                              />
                                                              <path
                                                                d="M11.9998 16.2218C13.1196 16.2218 14.1935 15.777 14.9852 14.9852C15.777 14.1935 16.2218 13.1196 16.2218 11.9998C16.2218 10.8801 15.777 9.80621 14.9852 9.01443C14.1935 8.22265 13.1196 7.77783 11.9998 7.77783C10.8801 7.77783 9.80621 8.22265 9.01443 9.01443C8.22265 9.80621 7.77783 10.8801 7.77783 11.9998C7.77783 13.1196 8.22265 14.1935 9.01443 14.9852C9.80621 15.777 10.8801 16.2218 11.9998 16.2218Z"
                                                                stroke="#AD3717"
                                                                strokeWidth="1.5"
                                                                strokeMiterlimit="10"
                                                                strokeLinecap="round"
                                            ...
                                            <div className="w-full lg:w-12/12  mt-2 mb-1">
                                              ...
                                              <section className="border p-[20px] rounded-[12px] border-[#E5E5E5] ">
                                                ...
                                                <div className="py-4">
                                                  <div className=" ">
                                                    <h2 className="font-semibold text-[14px] leading-[100%] tracking-[0] text-[#333333] font-manrope">
                                                      Mode of payment
                                                    </h2>
                                                  </div>
