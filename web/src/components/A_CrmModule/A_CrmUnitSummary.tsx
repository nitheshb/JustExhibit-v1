...
const CrmUnitSummary = ({
  ...
  const handleViewMore = () => {
    setVisibleCount((prev) => Math.min(prev + 3, unitTransactionsA.length))
  }
            ...
            <div className="bg-white flex justify-between h-[217px] flex-col rounded-2xl px-8 py-8 shadow-sm border border-gray-100">
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col items-center">
                  <RadialChart
                    progress={
                      selUnitPayload?.T_balance <= 0
                        ? 100
                        : selUnitPayload?.T_total
                        ? ((selUnitPayload?.T_received || 0) /
                            selUnitPayload?.T_total) *
                          100
                        : 0
                    }
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 justify-between">
                    ...
                    <span className="text-sm font-medium text-red-500 ml-2">
                      ₹{' '}
                      {selUnitPayload?.TotalNetSaleValueGsT?.toLocaleString(
                        'en-IN'
                      )}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 justify-between">
                    ...
                    <span className="text-sm font-medium text-red-500 ml-2">
                      ₹ {selUnitPayload?.T_received?.toLocaleString('en-IN')}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 justify-between">
                    <section className="flex flex-row">
                    ...
                    <span className="text-sm font-medium text-red-500 ml-2">
                      ₹ {selUnitPayload?.T_balance?.toLocaleString('en-IN')}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border flex flex-col h-[160px] justify-between border-gray-100">
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="text-center flex gap-2">
                  ...
                  <div>
                    <p className="font-manrope font-medium text-[12px] leading-[100%] tracking-normal text-[#666666] mb-1">
                      Stall No
                    </p>
                    <p className="font-manrope font-medium text-[16px] leading-[100%] tracking-normal text-[#1A1A1A]">
                ...
                <div className="text-center flex gap-2">
                  <div className="w-[30px] h-[30px] rounded-full border border-[#E5E5E5] shadow-[0px_0.75px_4px_0px_#0000001A] flex items-center justify-center">
                    ...
                    >
                      <path
                        d="M10.2911 9.79107C10.5782 9.50388 10.7423 9.121 11.0705 8.35522L12.2379 5.63128C12.3552 5.35758 12.4139 5.22073 12.3466 5.15342C12.2793 5.08611 12.1424 5.14476 11.8687 5.26207L9.14478 6.42947C8.379 6.75766 7.99612 6.92175 7.70893 7.20893M10.2911 9.79107C10.0039 10.0782 9.621 10.2423 8.85522 10.5705L6.13128 11.7379C5.85758 11.8552 5.72073 11.9139 5.65342 11.8466C5.58611 11.7793 5.64476 11.6424 5.76207 11.3687L6.92947 8.64478C7.25766 7.879 7.42175 7.49612 7.70893 7.20893M10.2911 9.79107L7.70893 7.20893"
                        stroke="#F44D21"
                        strokeWidth="1.125"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M16.5 8.5C16.5 12.6421 13.1421 16 9 16C4.85786 16 1.5 12.6421 1.5 8.5C1.5 4.35786 4.85786 1 9 1C13.1421 1 16.5 4.35786 16.5 8.5Z"
                        stroke="#F44D21"
                        strokeWidth="1.125"
                      />
                      <path
                        d="M9 1L9 2.125M9 16L9 14.875"
                        stroke="#F44D21"
                        strokeWidth="1.125"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M16.5 8.5L15.375 8.5M1.5 8.5L2.625 8.5"
                        stroke="#F44D21"
                        strokeWidth="1.125"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div>
                    ...
                    <p className="font-manrope font-medium text-[16px] leading-[100%] tracking-normal text-[#1A1A1A]">
                      {selUnitPayload?.area?.toLocaleString('en-IN')}
                    </p>
                  </div>
                </div>
                ...
                <div className="text-center flex gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-manrope font-medium text-[16px] leading-[100%] tracking-normal text-[#1A1A1A] mt-1">
                      Nithesh
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl p-6 h-[256px] shadow-sm border border-gray-100">
              ...
              <div className="grid grid-cols-4 gap-3 mb-6">
                {furnitureItems.map((item) => (
                  <div
                    key={item.id}
                    className="bg-gray-50 rounded-xl p-4 flex items-center justify-center aspect-square hover:bg-gray-100 transition-colors cursor-pointer"
                  >
                    {item.svg}
                  </div>
                ))}
              ...
              <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                <span className="font-inter font-bold text-[14px] leading-6 tracking-normal">
                  Total Pay
                </span>
